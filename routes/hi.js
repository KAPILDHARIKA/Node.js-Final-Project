...
router.post('/submit-help', async function(req, res) {
    ...
    router.post('/submit-help', async function(req, res) {
        if ((!req.body.employeeID) || (!req.body.managerID) || (typeof(req.body.employeeID) != 'string') || (typeof(req.body.managerID) != 'string')) {
            res.status(400).render("error", {
                errorMsg: "Something wrong with parameters"
            })
        }
...
router.post('/createacc', async function(req, res) {
    try {
        ...
        if ((!req.body.firstname) || (!req.body.lastname) || (!req.body.email) || (!req.body.username) || (!req.body.password) || (typeof(req.body.firstname) != 'string') || (typeof(req.body.lastname) != 'string') || (typeof(req.body.email) != 'string') || (typeof(req.body.username) != 'string') || (typeof(req.body.password) != 'string')) {
            res.status(400).render("error", {
                errorMsg: "Something wrong with parameters"
            })
        }
        ...
        if (result === "Success") {
            res.render("templates/signup", {
                error: "Manager Added Successfuly"
            });
            console.log("Test 2");
